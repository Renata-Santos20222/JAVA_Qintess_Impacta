...
public class ExemploMap {
	...
	public static void main(String[] args) {
		...
		listaColab.add(new Colaborador(2389, "Cristovão Col.", "Desenvolvedor", 3200.0));
		listaColab.add(new Colaborador(6300, "Pedro Alvares", "Atendente", 1350.0));
		
		Stream<Colaborador> streamColab = listaColab.stream();
		Stream<JogadorFutebol> streamJogador = streamColab.map(f -> new JogadorFutebol(
					f.getNome(),
